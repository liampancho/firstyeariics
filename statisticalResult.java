...
public class statisticalResult
{
   public static void main(String[]args)
   {
     ...
     float letterPercent=(letter*100)/total;
     float digitPercent=(digit*100)/total;
     float whitespacePercent=(whitespace*100)/total;
     float otherPercent=(other*100)/total;
     float totalPercent=(total*100)/total;
